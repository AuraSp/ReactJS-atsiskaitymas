...
function Editinfo({ data, onCancel, onSubmit }) {
    ...
    const editStudent = (e) => {
        e.preventDefault();
        onSubmit(e, name, surname, birthdate, town, program, group)
    }
    ...
    return (
        <tr className='edit'>
            ...
            <td className='buttons'>
                <button onClick={(e) => editStudent(e)} className='btn btn-danger border-0 text-warning mt-2'><MdOutlineCheckBox />
